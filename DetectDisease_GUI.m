...
%close all
clc
[filename, pathname] = uigetfile({'*.*';'*.bmp';'*.jpg';'*.gif';'*.png'}, 'Pick image');
...
figure,subplot(2,3,1);imshow(I);title('basic image'); subplot(2,3,3);imshow(segmented_images{1});title('Cluster 1'); subplot(2,3,4);imshow(segmented_images{2});title('Cluster 2');
subplot(2,3,6);imshow(segmented_images{3});title('Cluster 3');
set(gcf, 'Position', get(0,'Screensize'));
set(gcf, 'name','K means segmentation', 'numbertitle','off')
...
result = multisvm(Train_Feat,Train_Label,test);% send to the test value "test features"
